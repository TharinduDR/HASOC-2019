...
def run_keras_experiment():
    ...
    EMBEDDING_FILE = configParser.get('english_task_1_model-config', 'EMBEDDING_FILE')
    MODEL_PATH = configParser.get('english_task_1_model-config', 'MODEL_PATH')
    PREDICTION_FILE = configParser.get('english_task_1_model-config', 'PREDICTION_FILE')
